    ...
    partial class WindowKeypad
    {
        ...
        public void ControllerInteractionMouse(ControllerInput controllerInput)
        {
            try
            {
                ...
                if (vKeypadMappingProfile.KeypadMouseMoveEnabled && GetSystemTicksMilli() >= vControllerDelay_KeypadMouse)
                {
                    ...
                    vControllerDelay_KeypadMouse = GetSystemTicksMilli() + vControllerDelayTicks10;
                }
            }
            catch { }
        }
        ...
        public void ControllerInteractionKeyboard(ControllerInput controllerInput)
        {
            try
            {
                if (GetSystemTicksMilli() >= vControllerDelay_KeypadKeyboard)
                {
                    ...
                    if (controllerInput.Buttons[(byte)ControllerButtons.DPadRight].PressedRaw)
                    {
                    ...
                    if (controllerInput.Buttons[(byte)ControllerButtons.DPadUp].PressedRaw)
                    {
                    ...
                    if (controllerInput.Buttons[(byte)ControllerButtons.DPadDown].PressedRaw)
                    {
                    ...
                    if (controllerInput.Buttons[(byte)ControllerButtons.ThumbLeftUp].PressedRaw)
                    {
                    ...
                    if (controllerInput.Buttons[(byte)ControllerButtons.ThumbLeftRight].PressedRaw)
                    {
                    ...
                    if (controllerInput.Buttons[(byte)ControllerButtons.ThumbLeftDown].PressedRaw)
                    {
                    ...
                    if (!vKeypadMappingProfile.KeypadMouseMoveEnabled)
                    {
                        ...
                        if (controllerInput.Buttons[(byte)ControllerButtons.ThumbRightUp].PressedRaw)
                        {
                        ...
                        if (controllerInput.Buttons[(byte)ControllerButtons.ThumbRightRight].PressedRaw)
                        {
                        ...
                        if (controllerInput.Buttons[(byte)ControllerButtons.ThumbRightDown].PressedRaw)
                        {
                    ...
                    if (controllerInput.Buttons[(byte)ControllerButtons.B].PressedRaw)
                    {
                    ...
                    if (controllerInput.Buttons[(byte)ControllerButtons.X].PressedRaw)
                    {
                    ...
                    if (controllerInput.Buttons[(byte)ControllerButtons.Y].PressedRaw)
                    {
                    ...
                    if (controllerInput.Buttons[(byte)ControllerButtons.Back].PressedRaw)
                    {
                    ...
                    if (controllerInput.Buttons[(byte)ControllerButtons.Start].PressedRaw)
                    {
                    ...
                    //Shoulder
                    if (controllerInput.Buttons[(byte)ControllerButtons.ShoulderLeft].PressedRaw)
                    {
                    ...
                    if (controllerInput.Buttons[(byte)ControllerButtons.ShoulderRight].PressedRaw)
                    {
                    ...
                    //Trigger
                    if (controllerInput.Buttons[(byte)ControllerButtons.TriggerLeft].PressedRaw)
                    {
                    ...
                    if (controllerInput.Buttons[(byte)ControllerButtons.TriggerRight].PressedRaw)
                    {
                    ...
                    //Thumb
                    if (controllerInput.Buttons[(byte)ControllerButtons.ThumbLeft].PressedRaw)
                    {
                    ...
                    if (controllerInput.Buttons[(byte)ControllerButtons.ThumbRight].PressedRaw)
                    {
                    ...
                    //Delay input to prevent repeat
                    vControllerDelay_KeypadKeyboard = GetSystemTicksMilli() + vControllerDelayTicks10;
                }
            }
            catch { }
        }
