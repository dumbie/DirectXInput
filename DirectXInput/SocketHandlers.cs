    ...
    partial class WindowMain
    {
        ...
        async Task SendControllerStatusDetailsList(string targetIp, int targetPort)
        {
            try
            {
                ...
                controllerStatus0.Color = vControllerColor0.ToString();
                ...
                controllerStatus1.Color = vControllerColor1.ToString();
                ...
                controllerStatus2.Color = vControllerColor2.ToString();
                ...
                controllerStatus3.Color = vControllerColor3.ToString();
