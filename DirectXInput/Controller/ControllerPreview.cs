        ...
        void UpdateControllerPreviewInformation(ControllerStatus controller)
        {
            try
            {
                AVDispatcherInvoke.DispatcherInvoke(delegate
                {
                    ...
                    if (controller.InputCurrent.Buttons[(byte)ControllerButtons.Seven].PressedRaw) { img_ControllerPreview_ButtonSeven.Visibility = Visibility.Visible; } else { img_ControllerPreview_ButtonSeven.Visibility = Visibility.Collapsed; }
                    if (controller.InputCurrent.Buttons[(byte)ControllerButtons.Eight].PressedRaw) { img_ControllerPreview_ButtonEight.Visibility = Visibility.Visible; } else { img_ControllerPreview_ButtonEight.Visibility = Visibility.Collapsed; }
